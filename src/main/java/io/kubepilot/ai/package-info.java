/**
 * LLM backends and prompt assembly. Equivalent to k8sgpt's {@code pkg/ai}.
 *
 * <p>One adapter per provider, kept flat as in k8sgpt. A no-op backend is not optional: it is
